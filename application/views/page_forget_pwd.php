<div class="container">
    <form class="form-signin" action="" method="post">
        ...
        <input type="text" id="user_account" class="form-control" name="user_account" placeholder="手机号码" required autofocus>
        <div class="row">
            ...
            <div class="col-md-5" style="margin:0;padding:0 0 0 5px;">
                <a href="javascript:;" id="btn-get-sms-code" class="btn btn-lg btn-info btn-block form-control" data-url="<?php echo base_url('user/send_reset_sms_code'); ?>" type="button">获取短信验证码</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="btn-group btn-group-justified" role="group">
                <div class="btn-group" role="group">
                    <a href="javascript:;" id="btn-reset-submit"
                       data-url="<?php echo base_url('user/reset_pwd_handle'); ?>"
                       data-target="<?php echo base_url('user'); ?>" class="btn btn-lg btn-primary">重置</a>
                </div>
                <div class="btn-group" role="group">
...
<script type="text/javascript">
    $(function () {
        ...
        $('#btn-reset-submit').click(function (e) {
            e.preventDefault();
