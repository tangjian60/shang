...
<?php else: ?>
    <form class="form-horizontal form-task-dianfu">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">垫付任务详情</h3>
            </div>
            <div class="panel-body" style="padding:50px 0;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4" style="width: 49%">
                        ...
                        <p class="color-red">指定多个关键词方案，单数由关键词方案单数自动计算</p>
                    </div>
                </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding:50px 0;">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">
                        加入购物车下单<span class="label label-default">必填</span>
                    </label>
                    <div class="col-md-8">
                        <label class="radio-inline"><input class="is_add_cart" type="radio" name="is_add_cart" value="<?php echo STATUS_ENABLE; ?>">是</label>
                        <label class="radio-inline"><input class="is_add_cart" type="radio" name="is_add_cart" value="<?php echo NOT_AVAILABLE; ?>">否</label>
                        <p id="tips-is-add-cart" class="color-red"></p>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">
                        竞品加购物车<span class="label label-default">必填</span>
                    </label>
                    <div class="col-md-8">
                        <label class="radio-inline"><input class="is_compete_add_cart" type="radio" name="is_compete_add_cart" value="<?php echo STATUS_ENABLE; ?>">是</label>
                        <label class="radio-inline"><input class="is_compete_add_cart" type="radio" name="is_compete_add_cart" value="<?php echo NOT_AVAILABLE; ?>">否</label>
                        <p id="tips-compete-add-cart" class="color-red"></p>
                    </div>
                </div>
                <div class="form-group">
    ...
    <script type="text/javascript" src="<?php echo CDN_BINARY_URL; ?>seller-task.js?t=2018111914"></script>
<?php endif; ?>
