    ...
    <div class="panel-body" style="padding:50px 0;">
        <form class="form-horizontal form-bind-bank">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input placeholder="请填写开户银行全称" class="form-control" type="text" name="bank_name">
                    <p style="font-size:8px;color:red;" class="help-block">请填写开户银行全称，如：中国建设银行</p>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">
                ...
                <div class="col-md-8">
                    <input placeholder="请填写本人的银行卡" class="form-control" type="number" name="bank_card_num" onmousewheel="return false;" min="0">
        ...
        <div id="dialog-bank-add-success" class="modal fade" tabindex="-1" role="dialog" data-target="<?php echo base_url('pages/binded_bankcard'); ?>">
...
<div style="text-align:center;margin:50px auto;">
    <button id="btn-bind-bankcard" type="button" class="btn btn-lg btn-success" data-url="<?php echo base_url('requests/bind_bankcard_handle'); ?>">提交绑定</button>
</div>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#btn-bind-bankcard').click(function (e) {
            e.preventDefault();
            ...
            if (!number.test(form_data.bank_card_num)) {
                show_error_message('银行卡只能为数字');
                return;
            }
