                ...
                <table class="table table-bordered">
                    ...
                    <?php if ($data->status == Taskengine::TASK_STATUS_HPSH): ?>
                        <tr>
                            ...
                            <td>商家</td>
                            <td>
                                <a href="javascript:;" data-buyer-id="<?php echo $data->buyer_id;?>" data-id="<?php echo $data->id; ?>" data-url="<?php echo base_url('requests/task_operation_handle'); ?>" data-task-type="<?php echo $task_type; ?>" data-conclusion="<?php echo SELLER_CONCLUSION_REVIEW_OK; ?>" class="btn btn-sm btn-primary">审核通过</a>
                                <a href="javascript:;" data-buyer-id="<?php echo $data->buyer_id;?>" data-id="<?php echo $data->id; ?>" data-url="<?php echo base_url('requests/task_operation_handle'); ?>" data-task-type="<?php echo $task_type; ?>" data-conclusion="<?php echo SELLER_CONCLUSION_REVIEW_BAD; ?>" class="btn btn-sm btn-danger">审核不通过</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                </table>
